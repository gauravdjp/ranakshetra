...
const MOCK_TOURNAMENTS: Record<string, Tournament> = {
  "T001": {
    ...
    organiser: "SkyArena Esports", organiserContact: "skyarena@rk.gg",
    ...
    participants: [
      { rank: 1, name: "MYSTIC FC", tag: "MFC", region: "Bangalore", status: "active" },
      { rank: 2, name: "APEX SQUAD", tag: "APEX", region: "Hyderabad", status: "active" },
      { rank: 3, name: "STORM UNIT", tag: "SU", region: "Delhi", status: "active" },
      { rank: 4, name: "PIXEL CREW", tag: "PCR", region: "Mumbai", status: "active" },
      { rank: 5, name: "BYTE FORCE", tag: "BF", region: "Chennai", status: "eliminated" },
      { rank: 6, name: "NOVA GUILD", tag: "NVG", region: "Pune", status: "eliminated" },
      { rank: 7, name: "WIRED FC", tag: "WFC", region: "Kolkata", status: "active" },
      { rank: 8, name: "ZERO HOUR", tag: "ZH", region: "Bengaluru", status: "active" },
      { rank: 9, name: "IRON WOLVES", tag: "IW", region: "Ahmedabad", status: "active" },
      { rank: 10, name: "GHOST RECON", tag: "GR", region: "Jaipur", status: "active" },
      { rank: 11, name: "NEON BLADES", tag: "NB", region: "Lucknow", status: "active" },
      { rank: 12, name: "CRIMSON WAR", tag: "CW", region: "Kochi", status: "active" },
    ],
  },
  "T005": {
