    ...
    <>  
      ...
      <div className="min-h-screen bg-[#050510] flex items-center justify-center px-4 py-16 relative overflow-hidden">
        ...
        <div className="rk-card relative w-full max-w-[420px] bg-[rgba(255,255,255,0.02)] border border-[rgba(139,92,246,0.2)] p-8 md:p-10">
          ...
          {/* Error message */}
          {error && (
            <div className="mb-4 px-4 py-2 border border-red-500/30 bg-red-500/10 text-red-400 font-[Rajdhani,sans-serif] text-[0.8rem] tracking-wide text-center">
              {error}
            </div>
          )}
          ...
          <div className="login-fade-4 space-y-3">
            <button
              ...
              disabled={loading}
              className="rk-btn-primary w-full py-3 font-[Rajdhani,sans-serif] font-bold text-[0.9rem] tracking-[0.2em] uppercase text-white"
            >
